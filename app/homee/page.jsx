...
const page = () => {
    ...
    const caroselImages = ['/logo.svg', '/logo.svg', '/logo.svg', '/karade.png', '/optec.png', '/dressland.png', '/Ananta.png', '/logo.svg', '/logo.svg', '/logo.svg', '/logo.svg'];
    ...
    return (
        <div>
            ...
            <div className="bg-gray-600">
                <div className={`${Styles.exampleContainer} container mx-auto px-10 py-5 pb-20 `}>
            ...
            {/* Who we are */}
            <section>
                <div className="container mx-auto px-10 py-5 pt-0 my-11 ">
                    ...
                    <div className="who2 absolute -bottom-96 right-2/4 w-80 border">
            ...
            <div className=''>
                <div className="container mx-auto px-10 ">
                    <div className='w-fit container px-5  py-5 mx-auto'>
                        <div className='mx-auto px-5 py-5  text-center '>
                            <span isSelected={selectedTab === 1} onClick={() => setSelectedTab(1)} className={`cursor-pointer mx-1 px-5 py-2 inline rounded-md ${selectedTab == 1 ? 'bg-sky-500 text-white' : 'bg-white'}`}>
                                All
                            </span>
                            <span isSelected={selectedTab === 2} onClick={() => setSelectedTab(2)} className={`cursor-pointer mx-1 px-5 py-2 inline rounded-md ${selectedTab == 2 ? 'bg-sky-500 text-white' : 'bg-white'}`}>
                                Brand Development
                            </span>
                            <span isSelected={selectedTab === 3} onClick={() => setSelectedTab(3)} className={`cursor-pointer mx-1 px-5 py-2 inline rounded-md ${selectedTab == 3 ? 'bg-sky-500 text-white' : 'bg-white'}`}>
                                Logos & Branding
                            </span>
                            <span isSelected={selectedTab === 4} onClick={() => setSelectedTab(4)} className={`cursor-pointer mx-1 px-5 py-2 inline rounded-md ${selectedTab == 4 ? 'bg-sky-500 text-white' : 'bg-white'}`}>
                                Websites
                            </span>
                            <span isSelected={selectedTab === 5} onClick={() => setSelectedTab(5)} className={`cursor-pointer mx-1 px-5 py-2 inline rounded-md ${selectedTab == 5 ? 'bg-sky-500 text-white' : 'bg-white'}`}>
                                Marketing
                            </span>
                            <span isSelected={selectedTab === 6} onClick={() => setSelectedTab(6)} className={`cursor-pointer mx-1 px-5 py-2 inline rounded-md ${selectedTab == 6 ? 'bg-sky-500 text-white' : 'bg-white'}`}>
                                Print Media
                            </span>
                        </div>
                        <Separator />
